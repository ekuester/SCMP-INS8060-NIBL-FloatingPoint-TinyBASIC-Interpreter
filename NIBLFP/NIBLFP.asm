...
L_D1D8: LD	@-1(P1)
	...
	LD	-1(P1)
	XRI	0xA0
	JNZ	L_D1F5		; to X'D1F5
L_D1EA: LDI	0x30		; '0'
	CALL	P3,PUTASC
	DLD	-21(P2)
	JNZ	L_D1EA		; to X'D1EA
	JMP	SV_RTRN(P3)
L_D1F5: LD	@-1(P1)
	CALL	P3,PUTASC
	DLD	-21(P2)
	JNZ	L_D1D8		; to X'D1D8
	JMP	SV_RTRN(P3)
...
START:	DO	NEXT
	GOTO	AUTO		; FIRST ENTRY IN LOOKUP TABLE
	DO	BYE
	DO	CLEAR
	DO	CLOAD
	GOTO	CSAVE
	...
	GOTO	LIST
	GOTO	NEW
MIDDLE:	GOTO	RUN		; POSITION OF 'RUN'
	DO	IGNRE		; POSITION OF 'DATA'
	DO	IGNRE		; POSITION OF 'DEF'
	GOTO	DIM
	GOTO	DO
	DO	IGNORE		; POSITION OF 'ELSE'
	DO	BRK
	GOTO	FOR
	GOTO	GOSUB
	GOTO	GOTO
	...
	GOTO	INPUT
	GOTO	LINK
	GOTO	SYNTAX		; POSITION OF 'MAT' ( NOT IMPLEMENTED )
	GOTO	NEXTG
	GOTO	ON
	GOTO	PAGE
	GOTO	POKE
	GOTO	PRINT		; POSITION OF 'PRINT'
	GOTO	PRINT		; POSITION OF 'PR'
	GOTO	READ
	DO	IGNORE		; POSITION OF 'REM'
	GOTO	RESTOR
	GOTO	RETURN
	GOTO	STAT
	GOTO	UNTIL
ENDS:	TSTVAR	PAGE0		; FORMAL POSTION OF 'LET'
	DO	FNDVAR
	DO	DEFVAR
	TSTSTR	DOLLAR,'('
	ILCALL	INDEX
...
SAVE:	XPAH	P3
	...
	LD	-35(P2)
	XPPC	P3
SAVE1:	LDI	0x20		; COUNTER: 32 BYTES
	ST	-22(P2)
	LDI	0x00
	ST	-23(P2)
	CCL
...
LOAD2:	LD	-8(P2)		; LOAD BEGIN INTO P1
	...
	XPAL	P1
	XOR	-35(P2)
	JNZ	L_FF3E		; END ADDRESS REACHED?
	CALL	P3,FNDVAR
	JZ	L_FF4F
LOAD3:	LD	@-58(P3)
	XPAH	P3
