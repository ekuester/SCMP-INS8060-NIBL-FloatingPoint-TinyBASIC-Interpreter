...
L_D000: LDI    0x0C
        ...
        XPAH   P1
        LDI    0x00
        XPAL   P1             ;SET P1 WITH ADDRESS $1D00
        LDI    0x00
        ST     (P1)
        ST     127(P2)
        LDI    0x1F
        ...
        LDI    0x1C
        ST     -29(P2)
        LDE                   ;ADDRESS LOW 'READY'
ERRTYP: XPAL   P1
        LDI    0xD6           ;ADDRESS HIGH 'READY'
        XPAH   P1
SPACE:  LDI    0x20
        CALL   P3,PUTASC
TXTOUT: LD     @1(P1)
...
STRF1:  TSTSTR  STRF2,0xC5    ;'CHR$'
        ...
        DO      FIX
        DO      CHRSTR
STRF2:  TSTSTR  STRF4,0xC6    ;'LEFT$'ORG
        TSTSTR  SYNTAX,'('
        TSTSTR  STRF3,'"'
        DO      STPNT
        TSTSTR  SYNTAX,','
...
ENTRY:  DINT
        ...
        LDI     0x1E
        XPAL    P2
        LD      -122(P3)      ;PAGE FROM $D006
        XPAH    P2            ;LOAD P2 WITH $1C1E
        LDI     0x00
        ST      1(P2)
        LDI     0x00
        ST      (P2)
...
L_DFF8: XPAH    P1
        ...
        JNZ     L_DFE2
        NOP
        NOP                   ;WRAP AROUND TO BEGIN OF PAGE
GETLIN: LD      127(P2)
        ANI     0xBF
